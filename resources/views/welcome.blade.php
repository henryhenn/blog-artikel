                        ...
                        <div class="swiper-wrapper">
                            @foreach($articles as $article)
                                <div class="swiper-slide">
                                    <a href="{{route('home.show', $article)}}" class="img-bg d-flex align-items-end"
                                       style="background-image: url('{{asset('storage/' . $article->foto)}}');">
                                        <div class="img-bg-inner">
                                            <h2>{{$article->judul}}</h2>
                                            <p>{{\Illuminate\Support\Str::limit($article->isi, 100)}}</p>
                                        </div>
                                    </a>
                                </div>
                            @endforeach
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        <a href="single-post.html"><img src="{{asset('frontend/assets/img/post-landscape-1.jpg')}}"
                                                        alt=""
                                                        class="img-fluid"></a>
                        ...
                        <div class="d-flex align-items-center author">
                            <div class="photo"><img src="{{asset('frontend/assets/img/person-1.jpg')}}" alt=""
                                                    class="img-fluid">
                            </div>
                            <div class="name">
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        ...
                        <div class="col-lg-4 border-start custom-border">
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{asset('frontend/assets/img/post-landscape-8.jpg')}}" alt=""
                                        class="img-fluid"></a>
        ...
        <section class="category-section">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header d-flex justify-content-between align-items-center mb-5">
                    <h2>{{$category->keterangan}}</h2>
{{--                    <div><a href="{{route('list-category')}}" class="more">See All {{$category->keterangan   }}</a></div>--}}
                </div>
                    ...
                    @foreach($category->articles as $article)
                        <div class="col-md-4">
                            <div class="post-entry-1 border-bottom">
                                <img src="{{asset('storage/' . $article->foto)}}" class="img-fluid" width="300px" alt="">
                                <div class="post-meta"><span class="date">{{$article->category->keterangan}}</span> <span class="mx-1">&bullet;</span>
                                    <span>{{$article->created_at}}</span></div>
                                <h2 class="mb-2"><a href="{{route('home.show', $article->id)}}">{{$article->judul}}</a></h2>
                            </div>
                        </div>
                    @endforeach
                </div>
